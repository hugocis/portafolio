        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
          {nodes.length > 0 ? (
                        ...
                        <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/30 p-6">
                          ...
                          <div className="space-y-4">
                            {nodes
                              ...
                              .slice(0, 3)
                              .map((node) => (
                                <div key={node.id} className="border-l-4 border-gradient-to-b from-blue-500 to-purple-500 pl-4 bg-gradient-to-r from-blue-50/50 to-purple-50/50 rounded-r-lg p-3">
                      ...
                      <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/30 p-6">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {Array.from(
                            ...
                            <span
                              key={tag}
                              className="inline-block bg-gradient-to-r from-blue-100/80 to-purple-100/80 backdrop-blur-sm text-blue-800 text-xs px-3 py-1 rounded-full font-medium border border-blue-200/50"
                            >
                              {tag}
                            </span>
                          ))}
            ...
            <div className="text-center py-20">
              <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/30 p-12 max-w-md mx-auto">
