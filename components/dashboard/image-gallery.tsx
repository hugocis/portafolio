        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
          {images.map((url, index) => (
            <div
              ...
              className={`group relative aspect-square rounded-xl overflow-hidden border-2 border-gray-200 dark:border-slate-600 cursor-move transition-all duration-200 hover:scale-105 hover:shadow-xl ${
